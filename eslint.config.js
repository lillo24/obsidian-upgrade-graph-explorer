...
export default tseslint.config(
          ...
          patterns: [
            {
              group: [
                ...
                '@icarus-graph-explorer/source-provider-tauri/*',
                '@icarus-graph-explorer/vault-discovery-policy',
                '@icarus-graph-explorer/vault-discovery-policy/*',
  ...
  {
    files: ['packages/focus-schematic/**/*.{ts,tsx}'],
    ignores: [
      'packages/focus-schematic/**/*.test.{ts,tsx}',
      'packages/focus-schematic/**/test-fixture.ts',
    ],
    rules: {
      'no-restricted-imports': [
        'error',
          ...
          patterns: [
            {
              group: [
                ...
                '@icarus-graph-explorer/spatial-overrides/*',
                '@icarus-graph-explorer/presentation-overrides',
                '@icarus-graph-explorer/presentation-overrides/*',
                '@icarus-graph-explorer/renderer-reactflow',
                '@icarus-graph-explorer/renderer-reactflow/*',
                '@icarus-graph-explorer/renderer-sigma',
              ...
              message:
                'Focus Schematic production code may depend only on source-neutral core and view-projection.',
            },
          ],
        },
      ],
