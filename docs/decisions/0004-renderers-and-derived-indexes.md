...
KG0 installs none of these libraries. Projection code must preserve canonical precision even when aggregating nodes or edges. Renderer selection remains replaceable and measurable rather than becoming a domain constraint.
