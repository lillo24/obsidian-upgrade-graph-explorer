...
Deployment, Tauri, React Flow, Sigma/Graphology, Playwright/browser automation, backend, database, and cloud skills remain deliberately uninstalled through KG2.
