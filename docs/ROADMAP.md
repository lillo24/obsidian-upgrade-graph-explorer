...
| **HIER4B-PATCH2**          | Keep the root File visible in folder membership while excluding it from Soft folder-attraction centroids and force groups.                                                         | **Complete — merged on `main`.**                                                                                                                                                            |
| **HIER4B-SPACING**         | Compare direct-folder scope and normalized 1/3 vs 1/4 ancestor pull, then spread complete Soft modules radially over one fixed structural layout.                                  | **FIX4 candidate in PR #106 — immediate named-folder unity outranks topology splitting, followed by structurally safe rigid radial spacing; native graphical QA is required before merge.** |
| **HIER4B-UNIFIED-REGIONS** | Compare split-when-needed ancestor wrappers with a policy that spatially unifies displayed ancestor regions.                                                                       | **Later experiment — immediate named-folder unity is handled by HIER4B-SPACING-FIX4.**                                                                                                      |
