...
| **HIERDISC1**              | Add shared selective Heading-subtree visibility plus a canonical Focus Outline recovery surface for Classic and Modular Focus Hierarchy.                                           | **Implemented for QA — automated gates and optimized native build required; founder graphical approval gates merge.**                                                           |
