...
| **HIER4B-SPACING**         | Use more available canvas, spread Files/modules, and reduce cramped Soft-cluster interiors after folder semantics are frozen.                                                  | **Implemented candidate + Sandbox tuning slider — native graphical QA pending.**                                                                |
