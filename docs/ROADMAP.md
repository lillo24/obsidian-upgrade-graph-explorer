...
| **HIER3B** | Production modular worker and renderer preview with latest-result-wins adoption, caching/failure policy, and unchanged Classic fallback.              | **Release candidate — automated, browser, and build gates pass; optimized native graphical approval pending.** |
| **HIER3C** | Product adoption of modular Focus Hierarchy and Experimental exposure of the preserved Classic Focus Hierarchy.                                       | **Later.**                                                                                                     |
