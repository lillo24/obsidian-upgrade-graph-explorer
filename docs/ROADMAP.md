...
| **HIER4B-SPACING**         | Use more available canvas, spread Files/modules, and reduce cramped Soft-cluster interiors after folder semantics are frozen.                                                  | **Later — explicitly excluded from HIER4B-FIX3.**                                                                                               |
