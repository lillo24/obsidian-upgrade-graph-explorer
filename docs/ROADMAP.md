...
| **HIER4B**           | Soft Folder Clusters with a nested displayed folder hierarchy, derived singleton compression, composed context menus, area-targetable nested guides, and four-side File ports. | **Implemented — graphical cleanup approved; Soft macro-layout adoption remains undecided.** |
