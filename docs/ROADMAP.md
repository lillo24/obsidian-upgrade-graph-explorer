...
| **HIER4B-SPACING**         | Compare direct-folder scope and normalized 1/3 vs 1/4 ancestor pull, then spread complete Soft modules radially over one fixed structural layout.                              | **FIX2 candidate in PR #106 — corrected native adoption, immediate-parent Direct groups, and hull labels await native graphical QA; do not merge yet. Dense-graph Folder-strength continuity remains later work.** |
