...
| **HIER4B**      | Soft Folder Clusters with per-folder ancestor scope, interactive spatial guides, and geometry-scored four-side File ports.                            | **Under evaluation — HIER4B-FIX1 optimized Modular Preview awaits real-vault graphical review.** |
