...
| **HIER4B**                 | Soft Folder Clusters with a nested displayed folder hierarchy, derived singleton compression, composed context menus, area-targetable nested guides, and four-side File ports. | **Merged implementation — folder semantics, guides, cleanup, menus, and four-side ports graphically approved; quality patches remain.** |
