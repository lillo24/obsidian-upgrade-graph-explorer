...
| **HIER4B**           | Soft Folder Clusters with a nested displayed folder hierarchy, derived singleton compression, composed context menus, area-targetable nested guides, and four-side File ports. | **Under evaluation — POLISH1 hides File-only module borders and presents passive folder labels; graphical review pending.** |
