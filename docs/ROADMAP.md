...
| **HIER4B**           | Soft Folder Clusters with a nested displayed folder hierarchy, derived singleton compression, context-menu editing, nested spatial guides, and geometry-scored four-side File ports. | **Under evaluation — HIER4B-FIX2 optimized Modular Preview awaits real-vault graphical review.** |
