...
| **HIERDISC1**              | Add shared selective Heading-subtree visibility plus a unified Focus Explorer with projection-scoped Files and canonical Headings for Classic and Modular Focus Hierarchy.         | **FIX2 implemented for QA — dynamic module sizes preserve Nested Soft geometry through rigid child/parent/group packing; founder graphical approval gates merge.**              |
