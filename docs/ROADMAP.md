...
| **KG7 — Structural graph MVP**                               | Projection-driven hierarchical graph with focused scalability interactions and distinct non-resolved states.                                       | **Next** — KG6 projection contracts and renderer boundary are tested.                               |
