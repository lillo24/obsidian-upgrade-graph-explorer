...
| **HIER4B**           | Soft Folder Clusters with a nested displayed folder hierarchy, derived singleton compression, composed context menus, area-targetable nested guides, and four-side File ports. | **Under evaluation — HIER4B-FIX3 optimized Modular Preview awaits real-vault graphical review.** |
