...
| **HIER4B-SPACING**         | Compare direct-folder scope and normalized 1/3 vs 1/4 ancestor pull, then spread complete Soft modules radially over one fixed structural layout.                              | **FIX1 candidate in PR #106 — native graphical QA pending; do not merge yet.**                                                                  |
