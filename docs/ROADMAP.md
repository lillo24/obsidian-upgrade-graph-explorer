...
| **HIERDISC1**              | Add shared selective Heading-subtree visibility plus a unified Focus Explorer with projection-scoped Files and canonical Headings for Classic and Modular Focus Hierarchy.         | **FIX3 implemented for QA — Focus depth is uniform across neighborhood Files, with derived Custom and one-action All Files; founder graphical approval gates merge.**           |
