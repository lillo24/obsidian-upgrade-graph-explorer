...
| **HIER4A-PATCH2**          | Compare accepted Flat Directional bands with automatic one-level nested parent/child containment derived from canonical folder ancestry.                                       | **Implemented for QA — adoption, optional retention, or rejection awaits graphical approval.**                                                  |
