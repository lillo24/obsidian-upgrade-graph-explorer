...
| **HIERDISC1**              | Add shared selective Heading-subtree visibility plus a unified Focus Explorer with projection-scoped Files and canonical Headings for Classic and Modular Focus Hierarchy.         | **FIX1 implemented for QA — exact layout identity/adoption evidence and pending-control polish added; founder graphical approval gates merge.**                                 |
