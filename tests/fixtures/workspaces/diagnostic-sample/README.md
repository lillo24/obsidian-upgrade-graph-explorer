...
case-only compatibility clues, attachment inventory evidence, and a forwarded
duplicate-block diagnostic. The generated report contains structure and spans,
never source text.
