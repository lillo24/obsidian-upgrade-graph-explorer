...
const spacings = [0, 25, 50, 71, 72, 73, 75, 100] as const;
...
<title>HIER4B-SPACING-FIX1 Radial Spread Lab</title>
<style>
...
</style></head><body><div class="top"><h1>HIER4B-SPACING-FIX1 Radial Spread Lab</h1><div class="controls">
