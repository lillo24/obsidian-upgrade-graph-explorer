...
src/spatial-influence-worker.ts  Harness transport over the production pull contract.
src/spatial-influence.worker.ts  Separate worker entry for soft-attractor compute.
